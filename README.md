...
Software engineer with 14+ years building production systems, currently re-entering tech with a focus on quality engineering, automation, and process improvement. The repos below trace deliberate growth in test design, debugging methodology, and reusable test infrastructure — alongside hands-on application development in Ruby, TypeScript, JavaScript, and Bash.
...
Process improvement case studies and a write-up of my "Career OS" — a personal example of AI-augmented systems design — coming soon.
